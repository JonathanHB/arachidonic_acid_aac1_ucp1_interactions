...
cmd.load("../seg_0035_aac1_centered.gro")

cmd.create("protchain", "seg_0035_aac1_centered and poly")
cmd.create("phosphates", "seg_0035_aac1_centered and element P")
...
cmd.png(f"/Users/jonathanborowsky/Documents/grabelab/aac1-ucp1/aac1-cutaway_v1.png", width=2000, height=2000, ray=1)
