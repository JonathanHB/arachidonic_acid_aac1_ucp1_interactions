...
#run this script with: source /home/jonathan/Documents/grabelab/aac1-ucp1/paper-01/electric_potential/092025/vmd_pmepot_aac1_run6.tcl
...
set trj_upper /home/jonathan/Documents/grabelab/aac1-ucp1/long-aac1-ucp1/water_wires_2_noxyz/centered_trajectories_wire_s10/degrabo/aac1/run02/
#note these lists are not comma-delimited
set trajectories {aac1-degrabo-run02-seg11-wireframes-s10.xtc aac1-degrabo-run02-seg12-wireframes-s10.xtc aac1-degrabo-run02-seg13-wireframes-s10.xtc aac1-degrabo-run02-seg14-wireframes-s10.xtc aac1-degrabo-run02-seg15-wireframes-s10.xtc aac1-degrabo-run02-seg16-wireframes-s10.xtc}
...
set outpath /home/jonathan/Documents/grabelab/aac1-ucp1/long-aac1-ucp1/electric_potential/aac1_run6/

#start at 1 to avoid making an extra frame from the starting structure that doesn't correspond to a water wire
for {set i 350} {$i < 999} {incr i} {
    #set b [expr {$i}]
